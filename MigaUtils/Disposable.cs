...
namespace Acorisoft.Miga.Utils
{
    ...
    {
        public static T DisposeWith<T>(this T instance, ICollection<IDisposable> disposable) where T : IDisposable
        {
    ...
    public class DisposableCollector : ICollection<IDisposable>, ICancelable
    {
