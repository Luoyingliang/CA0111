...
namespace Acorisoft.Miga.Utils
{
    ...
    public static class Classes
    {
        ...
        {
            return new PropertySetter(instance.GetType(), instance);
        }
        ...
        public static Type FindInterfaceImplmentation(Assembly assembly, Type interfaceType)
        {
        ...
        /// <param name="interfaceType">指定要检索的接口类型，要求不能为空。</param>
        /// <returns>返回操作的结果，如果不存在则返回null。</returns>
        public static Type FindInterfaceImplmentation<T>(Assembly assembly)
        {
        ...
        /// <param name="interfaceType">指定要检索的接口类型，要求不能为空。</param>
        /// <returns>返回操作的结果，如果不存在则返回null。</returns>
        public static IEnumerable<Type> FindInterfaceImplmentations<T>(Assembly assembly)
        {
        ...
        /// <param name="interfaceType">指定要检索的接口类型，要求不能为空。</param>
        /// <returns>返回操作的结果，如果不存在则返回null。</returns>
        public static IEnumerable<Type> FindInterfaceImplmentations(Assembly assembly, Type interfaceType)
        {
            if (assembly is null || interfaceType is null)
            {
                return null;
    ...
    public class PropertySetter
    {
        ...
        internal PropertySetter(Type classType, object instance)
        {
            DataType = classType;
    ...
    public class PropertyProxy
    {
        ...
        internal PropertyProxy(Type classType, object instance, bool force)
        {
            ...
            { 
                ...
                Action<object, object> setterExpr = (i, val) => setMethod!.Invoke(i, new[] {val});
                Func<object, object> getterExpr = i => getMethod!.Invoke(i, null);
